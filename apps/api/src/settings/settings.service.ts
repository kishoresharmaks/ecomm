  ...
  async upsertGstSettings(actor: RequestUser, dto: UpsertGstSettingsDto) {
    const normalized = normalizeGstSettings({
      platform: {
        ...
        serviceSacCode: dto.platform.serviceSacCode,
        serviceDescription: dto.platform.serviceDescription,
      },
    ...
    const writes = [
      ...
      this.settingWrite(
        gstSettingKeys.serviceSacCode,
        gstSettingGroup,
        SettingValueType.STRING,
        normalized.platform.serviceSacCode,
      ),
      this.settingWrite(
        gstSettingKeys.serviceDescription,
        gstSettingGroup,
        SettingValueType.STRING,
        normalized.platform.serviceDescription,
      ),
      this.settingWrite(
  ...
  private gstAuditValue(settings: GstSettings): Prisma.InputJsonObject {
    return {
      platform: {
        ...
        serviceSacCode: settings.platform.serviceSacCode,
        serviceDescription: settings.platform.serviceDescription,
      },
