  ...
  return (
    <div className="grid gap-5">
      <div className="grid gap-4 md:grid-cols-3">
        <SellerMetric label="Statements" value={summary?.statementCount ?? statementsQuery.data?.total ?? 0} note="Generated by finance team" />
      ...
      {statements.length === 0 ? <SellerEmptyState title="No statements yet" message="Statements appear after finance team generates them from approved or paid payouts." /> : null}
