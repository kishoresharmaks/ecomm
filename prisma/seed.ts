...
const emailTemplates = [
  ...
  },
  {
    ...
    name: "B2B negotiation message for buyer",
    category: EmailTemplateCategory.B2B,
    subject: "New reply on your B2B enquiry #{{enquiryId}}",
  },
  {
    code: "B2B_ENQUIRY_MESSAGE_SELLER",
    name: "B2B negotiation message for seller",
    category: EmailTemplateCategory.B2B,
    subject: "Buyer replied on enquiry #{{enquiryId}}",
  },
  {
    code: "B2B_ORDER_EVENT",
    name: "B2B order event",
    category: EmailTemplateCategory.B2B,
    subject: "B2B order {{orderNumber}} update",
  },
  {
    code: "B2B_PAYMENT_EVENT",
    name: "B2B payment event",
    category: EmailTemplateCategory.PAYMENT,
    subject: "B2B payment update for {{orderNumber}}",
  },
  {
    code: "B2B_PAYOUT_ELIGIBLE",
    name: "B2B payout eligible",
    category: EmailTemplateCategory.B2B,
    subject: "B2B payout eligible for {{orderNumber}}",
  },
  {
...
const emailTriggerRules = [
  ...
  [
    "B2B_ENQUIRY_CONFIRMED_SELLER",
    EmailRecipientType.SELLER,
    EmailTemplateCategory.B2B,
    "B2B_ENQUIRY_CONFIRMED_SELLER",
  ],
  [
    "B2B_ENQUIRY_MESSAGE_BUYER",
    EmailRecipientType.BUSINESS_BUYER,
    EmailTemplateCategory.B2B,
    "B2B_ENQUIRY_MESSAGE_BUYER",
  ],
  [
    "B2B_ENQUIRY_MESSAGE_SELLER",
    EmailRecipientType.SELLER,
    EmailTemplateCategory.B2B,
    "B2B_ENQUIRY_MESSAGE_SELLER",
  ],
  [
    "B2B_ORDER_PROFORMA_BUYER",
    EmailRecipientType.BUSINESS_BUYER,
    EmailTemplateCategory.B2B,
    "B2B_ORDER_EVENT",
  ],
  [
    "B2B_ORDER_PROFORMA_SELLER",
    EmailRecipientType.SELLER,
    EmailTemplateCategory.B2B,
    "B2B_ORDER_EVENT",
  ],
  [
    "B2B_PURCHASE_ORDER_SUBMITTED_ADMIN",
    EmailRecipientType.ADMIN,
    EmailTemplateCategory.B2B,
    "B2B_ORDER_EVENT",
  ],
  [
    "B2B_PURCHASE_ORDER_ACCEPTED_BUYER",
    EmailRecipientType.BUSINESS_BUYER,
    EmailTemplateCategory.B2B,
    "B2B_ORDER_EVENT",
  ],
  [
    "B2B_PURCHASE_ORDER_ACCEPTED_SELLER",
    EmailRecipientType.SELLER,
    EmailTemplateCategory.B2B,
    "B2B_ORDER_EVENT",
  ],
  [
    "B2B_PAYMENT_PROOF_SUBMITTED_ADMIN",
    EmailRecipientType.ADMIN,
    EmailTemplateCategory.PAYMENT,
    "B2B_PAYMENT_EVENT",
  ],
  [
    "B2B_PAYMENT_OVERPAYMENT_ADMIN",
    EmailRecipientType.ADMIN,
    EmailTemplateCategory.PAYMENT,
    "B2B_PAYMENT_EVENT",
  ],
  [
    "B2B_PAYMENT_VERIFIED_BUYER",
    EmailRecipientType.BUSINESS_BUYER,
    EmailTemplateCategory.PAYMENT,
    "B2B_PAYMENT_EVENT",
  ],
  [
    "B2B_PAYMENT_VERIFIED_SELLER",
    EmailRecipientType.SELLER,
    EmailTemplateCategory.PAYMENT,
    "B2B_PAYMENT_EVENT",
  ],
  [
    "B2B_PAYMENT_REJECTED_BUYER",
    EmailRecipientType.BUSINESS_BUYER,
    EmailTemplateCategory.PAYMENT,
    "B2B_PAYMENT_EVENT",
  ],
  [
    "B2B_FULFILMENT_UNLOCKED_SELLER",
    EmailRecipientType.SELLER,
    EmailTemplateCategory.B2B,
    "B2B_ORDER_EVENT",
  ],
  [
    "B2B_PAYMENT_NOT_REQUIRED_SELLER",
    EmailRecipientType.SELLER,
    EmailTemplateCategory.B2B,
    "B2B_PAYMENT_EVENT",
  ],
  [
    "B2B_ORDER_FULFILLED_BUYER",
    EmailRecipientType.BUSINESS_BUYER,
    EmailTemplateCategory.B2B,
    "B2B_ORDER_EVENT",
  ],
  [
    "B2B_ORDER_FULFILLED_ADMIN",
    EmailRecipientType.ADMIN,
    EmailTemplateCategory.B2B,
    "B2B_ORDER_EVENT",
  ],
  [
    "B2B_PAYOUT_ELIGIBLE_SELLER",
    EmailRecipientType.SELLER,
    EmailTemplateCategory.B2B,
    "B2B_PAYOUT_ELIGIBLE",
  ],
