export const adminNav = [
  ...
  { group: "Commerce", label: "Services", href: "/admin/services" },
  { group: "Commerce", label: "Service bookings", href: "/admin/service-bookings" },
  ...
  { group: "Commerce", label: "B2B exceptions", href: "/admin/b2b-exceptions" },
  { group: "Commerce", label: "B2B cases", href: "/admin/b2b-cases" },
  { group: "Commerce", label: "B2B analytics", href: "/admin/b2b/analytics" },
  ...
  { group: "Finance", label: "Subscribed sellers", href: "/admin/subscribed-sellers" },
...
export const financeNav = [
  ...
  { group: "Collections", label: "B2B receivables", href: "/finance/b2b-receivables" },
  { group: "Collections", label: "Seller COD dues", href: "/finance/seller-cash-receivables" },
  ...
  { group: "Reports", label: "GST reports", href: "/finance/gst-reports" },
...
export const sellerNav = [
  { group: "Overview", label: "Dashboard", href: "/seller", capability: "ALL" },
  { group: "Setup", label: "Onboarding", href: "/seller/register", capability: "ALL" },
  { group: "Setup", label: "Store profile", href: "/seller/store-profile", capability: "ALL" },
  { group: "Retail", label: "Products", href: "/seller/products", capability: "RETAIL" },
  { group: "Retail", label: "Orders", href: "/seller/orders", capability: "RETAIL" },
  { group: "Retail", label: "Returns", href: "/seller/returns", capability: "RETAIL" },
  { group: "Retail", label: "Deals", href: "/seller/deals", capability: "RETAIL" },
  { group: "Retail", label: "Coupons", href: "/seller/coupons", capability: "RETAIL" },
  { group: "Retail", label: "Reviews", href: "/seller/reviews", capability: "RETAIL" },
  { group: "Services", label: "Services", href: "/seller/services", capability: "SERVICE" },
  { group: "Services", label: "Service bookings", href: "/seller/service-bookings", capability: "SERVICE" },
  { group: "Services", label: "Service calendar", href: "/seller/service-calendar", capability: "SERVICE" },
  { group: "Services", label: "Service reviews", href: "/seller/service-reviews", capability: "SERVICE" },
  ...
  { group: "Finance", label: "Statements", href: "/seller/finance/statements", capability: "ALL" },
] as const;
