...
export const marketplaceProductEssentialFields = [
  ...
  },
  {
    ...
    helpText: "Choose exactly which after-delivery resolutions customers can request.",
    displayInAdmin: true,
    displayInSpecifications: true,
  },
  {
    ...
    required: true,
    placeholder: "7",
    helpText: "Maximum days after delivery. Enter 0 when refund returns are unavailable.",
    displayInAdmin: true,
    displayInSpecifications: true,
  },
  {
    key: "replacementWindowDays",
    label: "Replacement days",
    inputType: "NUMBER",
    group: "FULFILMENT",
    required: true,
    placeholder: "7",
    helpText: "Maximum days after delivery. Enter 0 when replacements are unavailable.",
    displayInAdmin: true,
    displayInSpecifications: true,
  },
  {
    key: "returnReasons",
    label: "Accepted return reasons",
    inputType: "MULTI_TEXT",
    group: "FULFILMENT",
    required: false,
    placeholder: "Select from the approved marketplace reasons",
    helpText: "At least one approved reason is required when returns or replacements are available.",
    displayInAdmin: true,
